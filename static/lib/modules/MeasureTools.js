/**
 * Created by Extra on 2016/5/1.
 * Modified bu Extra on 2016/5/10.
 * Description:实现客户端测量距离功能
 * version: 1.0.0
 */
define("dextra/modules/MeasureTools", [
    "dojo/dom",
    "dojo/query",
    "dojo/_base/declare",
    "dojo/_base/lang",
    ...
    return declare(_WidgetBase, {
        declaredClass: "dextra.modules.MeasureTools",
        defaults: {
            map: null,
        ...
        _initalToolbar: function() {
            ...
            this.toolbar = new Draw(map, { showTooltips: true });
            this.toolbar.on("draw-complete", lang.hitch(this, this._drawComplete));
            query("#" + this.srcRefNode + " > .tool-li-cg").on("click", lang.hitch(this, this._startMeasureDistance));
            query("#" + this.srcRefNode + " > .tool-li-cm").on("click", lang.hitch(this, this._startMeasureArea));
        },
        ...
        _startMeasureDistance: function() {
            this.defaults.map.setMapCursor("url('static/cursor/ruler.cur'),auto");
