...
const calendar = {
 ...
 if (isLeap) {
    ...
    return { lYear: year, lMonth: month, lDay: day, Animal: calendar.getAnimal(year), IMonthCn: (isLeap ? "\u95f0" : '') + calendar.toChinaMonth(month), IDayCn: calendar.toChinaDay(day), cYear: y, cMonth: m, cDay: d, gzYear: gzY, gzMonth: gzM, gzDay: gzD, isToday, isLeap, nWeek, ncWeek: "\u661f\u671f" + cWeek, isTerm, Term, astro };
  },
